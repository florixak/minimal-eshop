...
const GetInTouch = () => {
  ...
  return (
    <Section
      title={t("about.getInTouch")}
      description={t("about.getInTouchDescription")}
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <Card className="border-secondary-100 text-center">
          <CardContent className="p-6 space-y-4">
            ...
            <div>
              <h3 className="font-semibold text-primary mb-2">{t("about.emailUs")}</h3>
        ...
        <Card className="border-secondary-100 text-center">
          <CardContent className="p-6 space-y-4">
            ...
            <div>
              <h3 className="font-semibold text-primary mb-2">{t("about.callUs")}</h3>
        ...
        <Card className="border-secondary-100 text-center">
          <CardContent className="p-6 space-y-4">
            ...
            <div>
              <h3 className="font-semibold text-primary mb-2">{t("about.visitUs")}</h3>
